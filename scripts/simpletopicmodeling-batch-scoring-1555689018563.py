...
# define variables
args = {'target': '/datasets/test-topic-probabilities.csv', 'remoteHost': '', 'sysparm': '', 'livyVersion': 'livyspark2', 'output_datasource_type': '', 'source': '/datasets/test.csv', 'remoteHostImage': '', 'execution_type': 'DSX', 'output_type': 'Localfile'}
...
# model_path = os.getenv("DSX_PROJECT_DIR") + os.path.join("/models", os.getenv("DSX_MODEL_NAME","simple-topic-modeling"), os.getenv("DSX_MODEL_VERSION","1"),"model")
